...
/// Central asset path tokens generated from the current Ramro `SAppAssets`.
///
/// Use this class instead of typing raw `assets/...` paths in feature screens.
class AppAssets {
  AppAssets._();
  ...
  /// Assets for iconsSmallLogo
  /// assets/icons/small_logo.png
  static const String iconsSmallLogo = "assets/icons/small_logo.png";
