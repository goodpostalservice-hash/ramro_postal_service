...
class CustomRow extends StatelessWidget {
  ...
  const CustomRow(
      {super.key, required this.text1, required this.text2, this.textColor});
        ...
        Expanded(
          ...
          child: Text(
            ...
            style: Get.textTheme.bodyMedium!
                .copyWith(color: textColor ?? Color.fromRGBO(71, 84, 103, 1)),
          ),
        ),
      ...
      children: [
        Row(children: [
          ...
          Text(
            text1,
            style: Get.textTheme.bodyMedium!
                .copyWith(color: Get.theme.colorScheme.shadow),
          )
          // SmallTxt(
          //   text: text1,
