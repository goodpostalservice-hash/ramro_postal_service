        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              ElevatedButton(
                onPressed: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) => ResetPasswordScreen(widget.phone,
                  widget.player_id)));
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Text('Verify OTP'.toUpperCase(), style: const TextStyle(fontSize: 15.0,
              ...
              Align(
                ...
                child: Padding(
                  ...
                  child: Text('Having trouble with your opt verification. Contact administration for support.', style: TextStyle(color: AppColors.lightGrey,
