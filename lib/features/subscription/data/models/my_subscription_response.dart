...
class MySubscriptionResponse extends Equatable {
  ...
  factory MySubscriptionResponse.fromJson(dynamic data) {
    if (data is Map<String, dynamic>) {
      return MySubscriptionResponse.fromMap(data);
    }
    if (data is Map) {
      return MySubscriptionResponse.fromMap(Map<String, dynamic>.from(data));
    }
