...
final List<AvailableOrderResponse> sampleOrders = [
...
class _OrderCard extends StatefulWidget {
  final AvailableOrderResponse order;
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      onTapUp: (_) {
        ...
        Get.toNamed(AppRoutes.orderDetails, arguments: o.id);
      },
                ...
                child: Row(
                  children: [
                    ...
                    _InfoChip(
                      ...
                      text: o.deliveryScope.toString().replaceAll('_', ' '),
                    ),
                  ],
                ),
              ),
                    ...
                    _AcceptButton(
                      ...
                      onTap: () {
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
                            content: Text('Accepted order ${o.trackingNumber}'),
