...
import 'package:ramro_postal_service/core/widgets/header_section.dart';
import 'package:ramro_postal_service/core/widgets/loading_state.dart';
import 'package:ramro_postal_service/features/package/presentation/controllers/package_controller.dart';
import 'package:ramro_postal_service/features/subscription/data/models/subscribe_request.dart';

import '../../data/models/available_package.dart' show AvailablePackageModel;
...
class _AvailablePackageScreenState extends State<AvailablePackageScreen> {
  ...
  int _currentPage = 0;
  final _packages = Get.find<PackageController>();
  @override
  void dispose() {
    _pageCtrl.dispose();
    super.dispose();
          ...
          child: Column(
            ...
            children: [
              ...
              HeaderSection(
                ...
                subtitle: 'Swipe to compare — pick what fits best',
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: _RamroCtaButton(
                      ...
                      cardTheme: cardTheme,
                      onTap: () {
                        final request = SubscribeRequest(package_id: pkg.id!);
                        Get.find<SubscriptionController>().subscribePackage(
                          request,
                        );
                      },
                    ),
...
class _RamroCtaButton extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final label = pkg.hasSubscribed! ? 'Subscribed' : 'Subscribe';
